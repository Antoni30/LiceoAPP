...
function ErrorMessage({ message, type = "error", autoHide = false, duration = 4000, onClose }) {
  ...
  return (
    <div className={`p-4 mb-4 rounded-md ${getStyles()} ${autoHide ? 'absolute top-0 right-0 z-50' : ''}`}>
