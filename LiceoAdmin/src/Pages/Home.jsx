...
function Home() {
  ...
  const getActionCards = () => {
    ...
    const adminActions = [
      ...
      {
        title: "Gestion de Años Lectivos",
        description: "Administra todos los años lectivos",
        icon: "📊",
        path: "/dashboard",
      ...
      },
      {
        ...
        description: "Administra todas las materias",
        icon: "📚",
        path: "/materias",
        color: "bg-neutral-300 text-green-800",
      },
      {
        title: "Gestion Año lectivo Actual",
        description: "Administra todas las materias del año actual",
        icon: "🗓️",
        path: `/cursos/${anio.id}`,
        color: "bg-red-100 text-green-800",
      },
    ];
    ...
    const teacherActions = [
      ...
      },
      {
        ...
        description: "Generacion de Reporte del Horario",
        icon: "⌚",
        path: "",
        color: "bg-blue-100 text-yellow-800",
      },
    ];
    ...
    <header className="bg-white shadow">
      <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          />
          <h1 className="text-2xl font-semibold tracking-wide text-blue-800">
            Bienvenido, {getRoleName()}
          </h1>
        </div>
    ...
    <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {getActionCards().map((action, index) => (
          ...
          >
            <div
              className={`${action.color} overflow-hidden shadow rounded-lg h-full`}
            >
              <div className="px-4 py-5 sm:p-6">
                <div className="flex items-center">
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                Tu rol actual no tiene acciones específicas asignadas. Contacta
                al administrador si necesitas acceso a más funciones.
              </p>
            </div>
          </div>
        </div>
